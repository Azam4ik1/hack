...
const DESC_RU =
  "ArzonTur — консультант по жилью за границей для поездок из Таджикистана. Направления: ОАЭ, Турция, Египет. Собираем заявки, ссылку Booking/TAAP пока не даём. Визовая справка из проверенной базы — это не агентство и не консульство. В любой момент напишите «оператор».";
